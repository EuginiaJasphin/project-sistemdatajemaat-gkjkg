$(document).ready(function(){
 ...
 // UNTUK DATA DIRI
 //ketika tombol tambah di-klik, maka formjemaat akan ditampilkan pada bagian #divFormContent
  $("#btntambah").click(function(){
		page="formpekerjaan.php";
	...
	$("select#pilihcari").change(function(){ 
  	if ($(this).val() == "idjemaat"){
  	  $("td#kolompilihkerja").show();
      $("input#fieldcari").show();
      $("input#fieldcari").focus();
    }
    else if ($(this).val() == "namajemaat"){
      $("td#kolompilihkerja").show();
      $("input#fieldcari").show();
      $("input#fieldcari").focus();
    }
    else{
      $("td#kolompilihkerja").hide();
    }
	});
	
	//menampilkan list data jemaat
	loadData();
