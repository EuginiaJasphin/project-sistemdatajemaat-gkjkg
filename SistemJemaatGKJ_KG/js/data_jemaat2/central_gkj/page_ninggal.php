...
include_once("pagination_class.php");
   ...
   else { $sql = "select * from tbl_meninggal WHERE id_jemaat like '%$_SESSION[wilayah]%' order by id_jemaat DESC";
...
<table id="tblninggal" width="860"><tr>
  ...
  <th width="112">Aksi
       ...
       <tr><td><?= $r['id_jemaat']; ?></td>
         ...
         <?= $r['thn']; ?></td>
         <td><?= $r['sebab']; ?></td>
       <td><a href="proses_data.php?action=del_ninggal&idninggal=<?= $r['id_jemaat'];?>" class="delete">delete</a><?php } //end while ?></td></tr>
