...
include_once("pagination_class.php");
   ...
   else { $sql = "select * from tbl_jemaat WHERE anak='anak' AND substr(id_jemaat,7,2) like'%$_SESSION[wilayah]%' order by id_jemaat DESC";
...
<table id="tblanak" width="860"><tr>
  <th width="168">ID jemaat </th>
  <th width="296">Nama</th>
  <th width="107">L/P</th>
  <th width="95">Gol Darah </th>
  <th width="170">Aksi
       <? 
       ...
       <td><?= $r['jkel']; ?></td>
       <td><?= $r['goldarah']; ?></td>
       <td>	<a href="formanak.php?action=update&id=<?= $r['id_jemaat'];?>" class="edit">edit</a> |
	    <a href="proses_data.php?action=del_anak&idelanak=<?= $r['id_jemaat'];?>" class="delete">delete</a>
		<?php } //end while ?></td></tr>
