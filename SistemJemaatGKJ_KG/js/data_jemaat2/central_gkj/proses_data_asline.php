<?php
  ...
  // respon balikan dari masing-masing proses tersebut adalah dalam format JSON.
	...
	$pernikahan=$_POST['pernikah'];$pasangan=$_POST['pasangan'];$wil=$_POST['wil'];$kode=$_POST['kode'];$hub=$_POST['hub'];
	$hobby=$_POST['hobby'];$minat=$_POST['minat'];$m_pelayanan=$_POST['m_pelayanan'];$nokk=$_POST['nokk'];
