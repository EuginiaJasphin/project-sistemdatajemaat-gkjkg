...
include_once("pagination_class.php");
    ...
    else{$sql = "select * from tbl_jemaat WHERE anak!='anak' AND ket='$_SESSION[wilayah]' order by id_jemaat DESC";
...
?>
  <table id="tbljemaat" width="860">
	  <tr>
	  <th width="11%">id </th>
      <th width="19%">Nama Jemaat </th><th width="35%">Alamat</th><th width="20%">No. Handphone</th><th width="15%">Aksi</th></tr>
		...
		<?php echo $row['alamat']; ?></td><td>
		<?php echo $row['no_hp']; ?></td><td>
		<a href="formjemaat.php?action=update&id=
		<?php echo $row['id_jemaat'];?>&id_foto=<?= $foto; ?>" class="edit">edit</a> | <a href="proses_data.php?action=del_jemaat&id=
		<?php echo $row['id_jemaat'];?>" class="delete">delete</a></td>
        </tr></div>
  		<?php } //end while ?>
