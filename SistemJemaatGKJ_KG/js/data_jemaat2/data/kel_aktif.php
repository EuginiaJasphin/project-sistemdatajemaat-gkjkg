...
<body>
<div align="center">DATA JEMAAT BERDASARKAN STATUS KEANGGOTAAN <br>
  Status Keanggotaan
  : 
  <?= $_REQUEST['status']; ?><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#E9E9E9">
    <td width="3%">No.</td>
    <td width="13%">ID-Jemaat</td>
    <td width="14%">Nama jemaat </td>
	...
	$kel= mysql_query("SELECT * FROM tbl_jemaat WHERE ket=$wil AND status='$status' ORDER BY jkel ASC");
	$no=1; 
