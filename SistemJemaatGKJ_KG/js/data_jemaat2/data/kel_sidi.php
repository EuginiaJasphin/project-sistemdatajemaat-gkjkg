...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#E9E9E9">
	...
	if ($status=='Sidi'){
	$kosong="!=''";$min="!='-'";
	$kel_baptis= mysql_query("SELECT B.id_jemaat, B.tanggalsidi,J.id_jemaat,J.nama_jemaat,J.jkel,J.tgl, J.bln, J.thn,J.ket 
	FROM tbl_babtis B, tbl_jemaat J
	WHERE B.id_jemaat=J.id_jemaat AND (B.tanggalsidi$kosong OR B.tanggalsidi$min) AND J.ket=$wil 
	...
	elseif ($status=='Belum Sidi'){
	$kosong="!=''";$min="!='-'";
	$b_baptis=mysql_query("SELECT id_jemaat,nama_jemaat, jkel,ket,tgl,ttl,bln,thn FROM tbl_jemaat WHERE	ket=$wil 
	ORDER BY jkel");
	$no=1;
    ...
    {echo "</td></tr><tr><td>";
	 ...
	 $blm_babtis=mysql_query("SELECT id_jemaat,tanggalsidi FROM tbl_babtis WHERE id_jemaat='$jemaat' 
	 AND (tanggalsidi$kosong OR tanggalsidi$min)");
