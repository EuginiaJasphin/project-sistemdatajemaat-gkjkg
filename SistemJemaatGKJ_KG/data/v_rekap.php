...
<body>
<img src="images/priview.gif" align="left" hspace="5"><a href="data/v_rekap2.php?id=<?php echo $_REQUEST['id'];?>">full view </a>
<div align="center">
<h3>KARTU KELUARGA GEREJA KRISTEN JAWA KOTAGEDE</h3>
<hr color="#666666" size="1" width="68%">
<?php
...
<BR>
PEKERJAAN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <? 
$sq = mysql_query("SELECT id_pekerjaan,jenispekerjaan FROM tbl_pekerjaan WHERE id_jemaat='$id_jemaat'"); while($ro = mysql_fetch_array($sq)){
	echo $ro['jenispekerjaan']; }
}?>
<BR>
<BR>
...
<table border="0" cellspacing="0" cellpadding="0" width="1097">
  <tr bgcolor="#EAEAEA" align="center">
    ...
    <td width="97" rowspan="2">ID Jemaat </td>
...
?>
  ...
  <tr>
	...
	$gerejababtis=$rows['gerejababtis'];
    ...
    <td><? 
	$gerejasidi=$rows['gerejasidi'];
	$sq = mysql_query("SELECT id_gereja,nama FROM tbl_gereja WHERE id_gereja='$gerejasidi'"); while($ro = mysql_fetch_array($sq)){
	echo $ro['nama']; }
	?></td>
    ...
    <td><? 
	$gereja=$row['gereja'];
	$sq = mysql_query("SELECT id_gereja,nama FROM tbl_gereja WHERE id_gereja='$gereja'"); while($ro = mysql_fetch_array($sq)){
	echo $ro['nama']; }
	?></td>
    <td><?= $row['tanggal']; ?></td>
    <td><?= $row['nosurat']; ?>
